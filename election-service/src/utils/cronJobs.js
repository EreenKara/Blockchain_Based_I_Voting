...
cron.schedule('* * * * *', async () => {
  console.log('Scheduled task started: Checking elections for results calculation');
...
for (let election of elections) {
  ...
  if (currentDate >= endDate) {
    console.log(`Election ${election.id} has ended. Requesting result calculation.`);
    ...
    console.log('Scheduled task completed: Election results calculation triggered.');
  } catch (error) {
